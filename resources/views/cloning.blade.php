            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap">
                        ...
                        <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link">Example</a></li>
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-githun"></i><small class="ms-2 d-md-none">Github</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-mneu-end">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    <h1 class="mt-4 display-3">Buid fast, responsive site with Bootstrap</h1>
                    <p class="fs-5 mt-3">Quickly design and customize responsive
                    mobile-first site with Bootstrap, the world's most popular front-end open source
                    toolkit, featuring sass variable and mixins, responsive grid system, extensive
                    prebuild components, and powerful JavaScrip plugin.</p>
                    <div class="row">
                    ...
                    <div class="text-muted">
                        Currently <strong>v5.3.0-alpha2.</strong> . <a href="#">v4.6.x docs</a> . <a href="#"All relesaes></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    They're design to work in any project, whether you use Bootstrao itself or not.
                    Use them as SVGs or icon fonts--both option give you vector scaling and easy customization via CSS.</p>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap ti the next level with premium
                        themes from the <a href="#">official Bootstrap Themes marketplace</a>. Themes are
                        built on Bootstrap as their own ectended frameworks, rich with new components and
                        pludins, documentation, and powerful build-tools</p>
                        <a class="icon-link icon-link-hover leade fw-semibold mb-5" href="#">
                            Browser Bootstrap Themes
                            <i class="bi bi-arrow-right mb-2"></i>
                        </a>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="{{ Vite::asset('resources/images/logo-black.svg') }}" alt="Bootstrap Logo" class="img-fluid" style="width: 40px;">
                            <div class="fs-5 ms-2 text-black">Bootstrap</div>
                        </div>
                    </a>
                    <div class="mt-2 text-muted">
                        <small>Design and built with all the love in the world by
                            the <a href="#" class="text-black">Bootstrap team</a> with the help
                            of <a href="#" class="text-black">our contributors</a>.</small>
                    </div>
                    <div class="mt-2 text-muted">
                        <small>Code lisensed <a href="#" class="text-black">MIT</a>,
                ...
                <div class="col-6 col-lg-2 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Open Coolective</a></li>
